...
mark_my_file(mark_file = [my search path to file], assignment_path = [assignment path])

### Mark the tasks "foo" and "bar" in the file
Mark specific tasks in a lab file by using the tasks argument:

mark_my_file(tasks = c("foo", "bar"), mark_file = [my search path to file], assignment_path = [assignment path])
